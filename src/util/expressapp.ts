...
var app = require(path.join(ABSOLUTE_PATH, "expressapp.js"));

// Now that the app is configured
// Let's start the app
var PORT = process.env.PORT || config?.server?.PORT || 300; // use either the port from environment, config file or default of 3000
// const PORT = 3000;
